...
#ifndef CPP_UNIT_PROJECTSTATISTICTESTCASE_H
#define CPP_UNIT_PROJECTSTATISTICTESTCASE_H

class ProjectStatisticTestCase: public CPPUNIT_NS::TestFixture
{
    CPPUNIT_TEST_SUITE(ProjectStatisticTestCase);
