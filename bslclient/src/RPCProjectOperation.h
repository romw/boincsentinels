...
#ifndef _RPCPROJECTOPERATION_H_
#define _RPCPROJECTOPERATION_H_

class CRPCProjectOperation: public CRPCProtocol
{
    DECLARE_DYNAMIC_CLASS(CRPCProjectOperation)

public:
    CRPCProjectOperation();
    CRPCProjectOperation(const wxChar* pszRPCName, wxUint32 uiRPCNameLength);
    virtual ~CRPCProjectOperation();
    ...
    virtual BSLERRCODE Execute(CHost* pHost, CRPCConnection::CONNECTIONTYPE type, CBSLProject* pProject);
