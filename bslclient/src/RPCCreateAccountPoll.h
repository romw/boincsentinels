...
#ifndef _RPCCREATEACCOUNTPOLL_H_
#define _RPCCREATEACCOUNTPOLL_H_

///
/// \brief Checks to see if the BOINC client has finished create account client RPC.
/// \details \{
...
/// \}
///
class CRPCCreateAccountPoll: public CRPCProtocol
{
    DECLARE_DYNAMIC_CLASS(CRPCCreateAccountPoll)

public:
    CRPCCreateAccountPoll();
    ~CRPCCreateAccountPoll();

    /// \brief Send the Create Account Poll RPC request to the BOINC client.
