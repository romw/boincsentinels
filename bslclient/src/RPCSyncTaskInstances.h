...
#ifndef _RPCSYNCTASKINSTANCES_H_
#define _RPCSYNCTASKINSTANCES_H_

class CRPCSyncTaskInstances: public CRPCProtocol
{
    DECLARE_DYNAMIC_CLASS(CRPCSyncTaskInstances)

public:
    CRPCSyncTaskInstances();
    ~CRPCSyncTaskInstances();
