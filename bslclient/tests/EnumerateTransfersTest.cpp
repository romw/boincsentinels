...
#include "EnumerateTransfersTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION(EnumerateTransfersTestCase);

void EnumerateTransfersTestCase::NullHandle()
{
...
void EnumerateTransfersTestCase::EmptyDataSet()
{
    ...
    rcEnumerate = pClient->EnumerateTransfers(hHost, oTransfers, false);
    ...
    CPPUNIT_ASSERT(0 == oTransfers.size());
}
