...
public:
    ...
    static wxString ConstructProjectTotalCredit(CBSLProject& bslProject);
    static wxString ConstructProjectAverageCredit(CBSLProject& bslProject);
    static wxString ConstructProjectResourceShare(CBSLProject& bslProject);
    ...
    static wxString ConstructTaskInstancePercentage(wxDouble& dPercentage);
    ...
    static wxTimeSpan DetermineTaskInstanceCPUTime(CBSLTaskInstance& bslTaskInstance);
    static wxDouble DetermineTaskInstancePercentage(CBSLTaskInstance& bslTaskInstance);
