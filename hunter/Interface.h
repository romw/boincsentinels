...
public:
    ...
    void OnHostDisconnecting(CBSLHostEvent& event);
    void OnHostDisconnected(CBSLHostEvent& event);
    void OnHostReconnecting(CBSLHostEvent& event);
    void OnHostConnectFailure(CBSLHostEvent& event);
    ...
    bool CreateNotebookPage(CViewBase* pNotebookPage);
    bool DeleteNotebook();
